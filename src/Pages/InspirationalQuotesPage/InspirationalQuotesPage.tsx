    ...
    return (
        <article className="quotes-container">
            ...
            <ul className="quotes">
                <li>
                    <Quotecard
                        quote={quotes[quoteOne].quote}
                        author={quotes[quoteOne].name}
                    />
                </li>
                <li>
                    <Quotecard
                        quote={quotes[quoteTwo].quote}
                        author={quotes[quoteTwo].name}
                    />
                </li>
                <li>
                    <Quotecard
                        quote={quotes[quoteThree].quote}
                        author={quotes[quoteThree].name}
                    />
                </li>
            </ul>
        </article>
